...
INCLUDE=include/auxiliary.cpp include/LeftOrder.cpp include/RightOrder.cpp include/OrderScoring.cpp include/opruner_right.cpp include/path_pruning.cpp
#INCLUDE=include/*.cpp
