...
for (alg in algs){
  ...
  ggsave(paste0("figures/",alg,"_regplots.png"))
  ...
  ggsave(paste0("figures/",alg,"_boxplots_time_vs_totorders.png"))
  ...
  ggsave(paste0("figures/",alg,"_boxplots_n_vs_timeandtotorders.png"))
  ...
  ggplot(timing_1, aes(x=as.factor(n), y=sqrt(totaltime/tot_particles), col=as.factor(d))) + geom_boxplot() + xlab("p") + theme_bw() + 
    ...
    labs(col = "d") +
    theme(text = element_text(size = 12), axis.title = element_text(size = 14))
  ggsave(paste0("figures/",alg,"_boxplots_n_vs_sqrttimeandtotorders.png"))
  ...
  ggsave(paste0("figures/",alg,"_boxplots_timing_log.png"))
  ...
  ggplot(timing, aes(x=as.factor(n), y=log2(tot_particles), col=as.factor(d))) + geom_boxplot() + xlab("p") + ylab(TeX("$\\log_2(\\Sigma_N)$")) +theme_bw() + labs(col = "d") +
       theme(axis.title = element_text(size = 14))
  ggsave(paste0("figures/",alg,"_boxplots_totparticles_log.png"))
}
